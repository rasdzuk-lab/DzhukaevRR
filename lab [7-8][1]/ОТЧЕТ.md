...
код которого сохранён в виде файла parse2.py.
```Python
...
Результаты выполнения скрипта report.py представлены ниже. Отчёт сохранён в файле 
ontology_report.csv.
<img src="docs/results_1.png" />

Вывод программы из parse.py выглядит следующим образом.
...
индивидами.
3. Отредактированы онтологии, созданы скрипты для их анализа и получены отчёты о результатах
данного анализа.
